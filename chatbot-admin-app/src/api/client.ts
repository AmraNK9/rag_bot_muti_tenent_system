...
export const updateChatbot = (name: string, description: string, bot_token?: string, handover_timeout_mins?: number) =>
  api.put('/chatbot-admin/chatbot', { name, description, bot_token, handover_timeout_mins }).then((r) => r.data.chatbot);
